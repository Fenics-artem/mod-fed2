...
/* harmony export */ });
/* unused harmony exports ITERATE_KEY, customRef, deferredComputed, effect, effectScope, enableTracking, getCurrentScope, isReadonly, onScopeDispose, readonly, shallowReadonly, shallowRef, stop, toRef, toRefs, triggerRef, unref */
...
function computed(getterOrOptions, debugOptions) {
    ...
    const cRef = new ComputedRefImpl(getter, setter, (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .isFunction */ .mf)(getterOrOptions) || !getterOrOptions.set);
    if (false) {}
    return cRef;
}
...
/* harmony export */ });
/* unused harmony exports $computed, $fromRefs, $raw, $ref, $shallowRef, Comment, KeepAlive, Static, Suspense, Teleport, Text, callWithErrorHandling, cloneVNode, compatUtils, createCommentVNode, createElementBlock, createElementVNode, createHydrationRenderer, createSlots, createStaticVNode, createTextVNode, defineComponent, defineEmits, defineExpose, defineProps, devtools, guardReactiveProps, handleError, initCustomFormatter, inject, isMemoSame, isRuntimeOnly, isVNode, mergeDefaults, mergeProps, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onServerPrefetch, onUnmounted, provide, queuePostFlushCb, registerRuntimeCompiler, renderList, renderSlot, resolveDirective, resolveDynamicComponent, resolveFilter, setBlockTracking, setDevtoolsHook, ssrContextKey, ssrUtils, toHandlers, transformVNodeArgs, useAttrs, useSSRContext, useSlots, version, warn, watch, watchEffect, watchPostEffect, watchSyncEffect, withAsyncContext, withCtx, withDefaults, withDirectives, withMemo */
...
const deprecationData = {
    ...
    ["COMPONENT_V_MODEL" /* COMPONENT_V_MODEL */]: {
        message: (comp) => {
            ...
            if (comp.props &&
                ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .isArray */ .kJ)(comp.props)
...
function defineAsyncComponent(source) {
    if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .isFunction */ .mf)(source)) {
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
        ...
        const effect = new _vue_reactivity__WEBPACK_IMPORTED_MODULE_1__/* .ReactiveEffect */ .qq(componentUpdateFn, () => queueJob(instance.update), instance.scope // track it in component's effect scope
        );
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "@vue3-demo/home:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_vue3_demo_home"] = self["webpackChunk_vue3_demo_home"] || [];
...
function patchStyle(el, prev, next) {
    ...
    else if ((0,shared_esm_bundler/* isString */.HD)(next)) {
        if (prev !== next) {
...
prevChildren, parentComponent, parentSuspense, unmountChildren) {
    ...
    if (value === '' || value == null) {
        ...
        if (type === 'boolean') {
            // e.g. <select multiple> compiles to { multiple: '' }
            el[key] = (0,shared_esm_bundler/* includeBooleanAttr */.yA)(value);
            return;
        }
...
function parseName(name) {
    ...
    return [(0,shared_esm_bundler/* hyphenate */.rs)(name.slice(2)), options];
}
function createInvoker(initialValue, instance) {
    const invoker = (e) => {
        ...
        if (skipTimestampCheck || timeStamp >= invoker.attached - 1) {
            (0,runtime_core_esm_bundler/* callWithAsyncErrorHandling */.$d)(patchStopImmediatePropagation(e, invoker.value), instance, 5 /* NATIVE_EVENT_HANDLER */, [e]);
        }
    };
...
const TransitionPropsValidators = (Transition.props =
    /*#__PURE__*/ (0,shared_esm_bundler/* extend */.l7)({}, runtime_core_esm_bundler/* BaseTransition.props */.P$.props, DOMTransitionPropsValidators));
/**
...
const hasExplicitCallback = (hook) => {
    return hook
        ? (0,shared_esm_bundler/* isArray */.kJ)(hook)
...
const vModelText = {
    created(el, { modifiers: { lazy, trim, number } }, vnode) {
        ...
        addEventListener(el, lazy ? 'change' : 'input', e => {
            ...
            if (trim) {
                ...
                domValue = (0,shared_esm_bundler/* toNumber */.He)(domValue);
            }
            el._assign(domValue);
        });
        if (trim) {
    ...
    beforeUpdate(el, { value, modifiers: { lazy, trim, number } }, vnode) {
        ...
        if (document.activeElement === el) {
            ...
            if ((number || el.type === 'number') && (0,shared_esm_bundler/* toNumber */.He)(el.value) === value) {
                return;
            }
        }
        const newValue = value == null ? '' : value;
    ...
    created(el, { value, modifiers: { number } }, vnode) {
        ...
        addEventListener(el, 'change', () => {
            const selectedVal = Array.prototype.filter
                ...
                .map((o) => number ? (0,shared_esm_bundler/* toNumber */.He)(getValue(o)) : getValue(o));
...
const rendererOptions = (0,shared_esm_bundler/* extend */.l7)({ patchProp }, nodeOps);
...
function ensureRenderer() {
    return (renderer ||
        (renderer = (0,runtime_core_esm_bundler/* createRenderer */.Us)(rendererOptions)));
}
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[4].use[0]!./src/App.vue?vue&type=template&id=456e3b86&scoped=true

const _withId = /*#__PURE__*/(0,runtime_core_esm_bundler/* withScopeId */.HX)("data-v-456e3b86")

;(0,runtime_core_esm_bundler/* pushScopeId */.dD)("data-v-456e3b86")
const _hoisted_1 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createVNode */.Wm)("h3", null, "Main App", -1 /* HOISTED */)
;(0,runtime_core_esm_bundler/* popScopeId */.Cn)()

const Appvue_type_template_id_456e3b86_scoped_true_render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_Content = (0,runtime_core_esm_bundler/* resolveComponent */.up)("Content")
  const _component_Button = (0,runtime_core_esm_bundler/* resolveComponent */.up)("Button")

  return ((0,runtime_core_esm_bundler/* openBlock */.wg)(), (0,runtime_core_esm_bundler/* createBlock */.j4)("div", null, [
    _hoisted_1,
    (0,runtime_core_esm_bundler/* createVNode */.Wm)(_component_Content),
    (0,runtime_core_esm_bundler/* createVNode */.Wm)(_component_Button)
  ]))
})
;// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=456e3b86&scoped=true
...
/* harmony default export */ const Appvue_type_script_lang_js = ({
  components: {
    Content: (0,runtime_core_esm_bundler/* defineAsyncComponent */.RC)(() => __webpack_require__.e(/* import() */ 406).then(__webpack_require__.bind(__webpack_require__, 605))),
    Button: (0,runtime_core_esm_bundler/* defineAsyncComponent */.RC)(() => __webpack_require__.e(/* import() */ 488).then(__webpack_require__.bind(__webpack_require__, 347))),
  },
  // components: {
  //   Content,
  //   Button,
...
;
Appvue_type_script_lang_js.render = Appvue_type_template_id_456e3b86_scoped_true_render
Appvue_type_script_lang_js.__scopeId = "data-v-456e3b86"
